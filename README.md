...
It then lets users enter a trip budget, adjust estimated ticket prices, set delay/cancellation cost assumptions, and compare options by risk-adjusted cost.
